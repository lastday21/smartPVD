...
lambda_dist   = 1400        # м – расстояние, на котором влияние падает ~в e раз
...
divider_q: float = 2.5 # Делители для расчета CI Δq
divider_p: float = 3.0 # Делители для расчета CI Δp
w_q: float = 0.3 # Веса для расчёта CI (сумма w_q + w_p должна быть = 1.0)
w_p: float = 0.7 # Веса для расчёта CI (сумма w_q + w_p должна быть = 1.0)

CI_THRESHOLDS = (2, 4, 6)  # none <2, weak <4, medium <6, strong ≥6
